...
def gaia_gloess_fit_and_plot(source_id, period='query', period_col='pf', plot=True, save_pdf=True, save_fit=True, alt_id = ''):
    ...
    fit_results, gaia_period, df, gloess, = fit_gloess_from_gaia_query(source_id, period, period_col)
    if plot==True:
        fn = plot_gaia_gloess_fits(fit_results, df, gloess, source_id, gaia_period, save_pdf, alt_id)
